 ...
 *
 * Verifica el mapeo de la respuesta de PokéAPI a nuestro tipo Pokemon.
 * Funciones puras = sin mocks, sin render, más rápidos.
 */
...
// Fixture mínimo que imita la estructura real de PokéAPI
const mockPokemonResponse: GetPokemonResponse = {
    ...
    sprites: {
        ...
        back_default: '',
        other: {
            'official-artwork': { front_default: 'https://example.com/6.png' },
            home: { front_default: '', back_default: '' },
        },
    },
    types: [
        { type: { name: 'fire' } },
