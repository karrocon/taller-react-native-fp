// MINI 03 — Ejercicio: Personalizar el header
//
// OBJETIVO: Cambiar colores y título dinámico del header con screenOptions y options
//
// TODO 1: En Stack.Navigator, añade screenOptions para cambiar el color del header:
//           headerStyle: { backgroundColor: '#e91e63' }
//           headerTintColor: 'white'
// TODO 2: En la Stack.Screen de PantallaB, usa options con una función para mostrar
//           el nombre recibido como título dinámico:
...
export default function Mini03Ejercicio() {
  return (
    <NavigationContainer>
      {/* TODO 1: Añade screenOptions con headerStyle backgroundColor rosa y headerTintColor white */}
      <Stack.Navigator>
        <Stack.Screen name="PantallaA" component={PantallaA} options={{ title: 'Inicio' }} />
        {/* TODO 2: Cambia options de PantallaB a una función que devuelva { title: route.params.nombre } */}
        <Stack.Screen name="PantallaB" component={PantallaB} options={{ title: 'Bienvenida' }} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
