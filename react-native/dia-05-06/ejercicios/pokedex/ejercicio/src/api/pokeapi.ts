// src/api/pokeapi.ts — Funciones centralizadas para PokéAPI

import type { PokemonLista } from '../types/pokemon';

const BASE   = 'https://pokeapi.co/api/v2';
const SPRITE = (id: string | number): string =>
...
export async function fetchDetalle(id: string | number): Promise<Response> {
